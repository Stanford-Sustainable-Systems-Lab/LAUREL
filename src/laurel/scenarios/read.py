...
- **Path-based metadata extraction**: scenario metadata (e.g. adoption-rate
  ...
  :class:`~laurel.scenarios.build.ScenarioBuilder`; concrete readers
...
class ScenarioReader(ABC):
    ...
    - :attr:`builder` — the :class:`~laurel.scenarios.build.ScenarioBuilder`
    ...
    Class attributes:
        builder: The :class:`~laurel.scenarios.build.ScenarioBuilder` class
    ...
    def metadata_level_names(self: Self) -> tuple[str]:
        ...
        :attr:`~laurel.scenarios.build.ScenarioBuilder.partition_level_names`
...
class TestScenarioReader(ScenarioReader):
    ...
    Pairs with :class:`~laurel.scenarios.build.TestScenarioBuilder`.
