...
- **Path-based metadata extraction**: scenario metadata (e.g. adoption-rate
  ...
  :class:`~megaplug.scenarios.build.ScenarioBuilder`; concrete readers
...
class ScenarioReader(ABC):
    ...
    - :attr:`builder` — the :class:`~megaplug.scenarios.build.ScenarioBuilder`
    ...
    Class attributes:
        builder: The :class:`~megaplug.scenarios.build.ScenarioBuilder` class
    ...
    def metadata_level_names(self: Self) -> tuple[str]:
        ...
        :attr:`~megaplug.scenarios.build.ScenarioBuilder.partition_level_names`
...
class TestScenarioReader(ScenarioReader):
    ...
    Pairs with :class:`~megaplug.scenarios.build.TestScenarioBuilder`.
