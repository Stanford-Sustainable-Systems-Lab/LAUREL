...
delegates to its :meth:`~megaplug.scenarios.build.ScenarioBuilder.build_configs`
method.
...
builder definitions::
    ...
    from megaplug.scenarios.nodes import generate_scenario_configs  # noqa: F401
...
def generate_scenario_configs(scen_params: dict, all_params: dict) -> dict:
    ...
    :class:`~megaplug.scenarios.build.ScenarioBuilder`, instantiates the one
    whose class name matches ``scen_params["builder"]``, calls
    :meth:`~megaplug.scenarios.build.ScenarioBuilder.build_configs`, and
    ...
    Returns:
        ...
        :attr:`~megaplug.scenarios.build.ScenarioBuilder.n_tasks_generated`
        is set and available for downstream nodes such as
        :func:`~megaplug.scenarios.cmd.generate_bash_script`).
